...
namespace LibCoAPNonIP.CoAPMsg {
    public abstract class AbstractCoAPMsg {
        ...
        {
            if (coapMsgStream == null || coapMsgStream.Length < AbstractCoAPMsg.HEADER_LENGTH /*minimum header length*/)
        ...
        {
            int streamLength = AbstractCoAPMsg.HEADER_LENGTH + /*mandatory header*/
        ...
        {
            if (this.ID == null) this.ID = new CoAPMsgID();
            this.ID.Value = mId;
        }
        /// <summary>
        /// Get the message id
